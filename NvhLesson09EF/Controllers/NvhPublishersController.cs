...
{
    public class NvhPublishersController : Controller
    {
        private readonly NvhBookStoreContext _context;

        public NvhPublishersController(NvhBookStoreContext context)
        {
            _context = context;
        }
        ...
        // GET: NvhPublishers/Create
        public IActionResult NvhCreate()
        {
            return View();
        }

        // POST: NvhPublishers/Create
